...
IMPORTANT: Output HTML format with proper tags:
- Use <p> for paragraphs
- Use <strong> for bold text
- Use <h3> for subject lines
- Include [Return to Your Cart] as placeholder text that will be converted to a button link
- NO markdown formatting (no **, ###, etc.)

Generate a compelling cart recovery message in HTML format:";
