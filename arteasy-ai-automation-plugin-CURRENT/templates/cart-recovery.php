...
<div class="wrap arteasy-cart-recovery">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description">Enter customer's name for personalization</p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div id="cart-items-container">
                                <div class="cart-item">
                                    <input type="text" name="item_name[]" placeholder="Product Name" class="regular-text" />
                                    <input type="number" name="item_price[]" placeholder="Price (₦)" class="small-text" step="0.01" />
                                    <button type="button" class="button remove-item">Remove</button>
                                </div>
                            </div>
                            <button type="button" id="add-cart-item" class="button">Add Item</button>
                            <p class="description">Add products that were abandoned in cart</p>
                        </td>
                    </tr>
                </table>
    ...
    <div class="recovery-controls" style="background: white; padding: 20px; border: 1px solid #e1e5e9; border-radius: 10px; margin-bottom: 20px;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px; margin-top: 15px;">
            <div>
                <strong>Status:</strong> <?php echo $recovery_active ? '<span style="color: green;">✅ Active</span>' : '<span style="color: red;">❌ Inactive</span>'; ?>
            </div>
            <div>
